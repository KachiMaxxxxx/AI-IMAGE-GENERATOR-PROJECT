...
/* window.addEventListener("DOMContentLoaded", () => {
  const savedModel = localStorage.getItem("selectedModel") || "stabilityai/stable-diffusion-2-1-base";
  const savedCount = localStorage.getItem("imageCount") || "1";
  const savedRatio = localStorage.getItem("aspectRatio") || "16/9";
...
countSelect.addEventListener("change", (event) => {
  const imageCount = event.target.value;
